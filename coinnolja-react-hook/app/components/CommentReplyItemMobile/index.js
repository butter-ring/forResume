...
function CommentReplyItemMobile({ comment, isSignin }) {
...
CommentReplyItemMobile.propTypes = {
...
// export default CommentReplyItemMobile;
export default compose(withConnect)(CommentReplyItemMobile);
