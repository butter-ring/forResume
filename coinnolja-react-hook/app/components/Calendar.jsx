  ...
  renderCells() {
    ...
    function checkAttend(totaldays) {
      for (let j = 0; j < content.length; j++) {
        if (
          totaldays === content[j].attendDate
    ...
    while (day <= endDate) {
      for (let i = 0; i < 7; i++) {
        ...
        // const afaf = dateFns.format(new Date(1556290793971),'yyyy-MM-dd');
        ...
        days.push(
          ...
          <div
            className={`col cell ${
              !dateFns.isSameMonth(day, monthStart)
                ...
                : checkAttend(totalday) // 날짜별로 확인하여 출석도장 넣어주기
                ? 'coinnolja' // 참 : 달력에 출석 도장찍기
                : '' // 거짓 : 공백
                ? weekendcolor(i) // red
                : weekendcolor(i) // blue
            }`}
          ...
          >
            {/* <img className="img_stamp" src={logo1} /> */}
