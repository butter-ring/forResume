  ...
  return (
    <div className={classes.agreeContent}>
      <p className={classes.agreeP}>
        제1조(목적) 이 약관은 Cube Exchange 회사(전자상거래 사업자)가 운영하는
        큐브 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
      ...
      <br />
      <p className={classes.agreeP}>제2조(정의)</p>
      <p className={classes.agreeP}>
        ① “몰”이란 Cube Exchange 회사가 재화 또는 용역(이하 “재화 등”이라 함)을
      ...
      <br />
      <p className={classes.agreeP}>제4조(서비스의 제공 및 변경)</p>
      <p className={classes.agreeP}>① “몰”은 다음과 같은 업무를 수행합니다.</p>
      <p className={classes.agreeP}>
        {' '}
      ...
      <p className={classes.agreeP}> 3. 기타 “몰”이 정하는 업무</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제5조(서비스의 중단)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제6조(회원가입)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제7조(회원 탈퇴 및 자격 상실 등)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제8조(회원에 대한 통지)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제9조(구매신청 및 개인정보 제공 동의 등)</p>
      <p className={classes.agreeP}>
        ① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를
        신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기
        쉽게 제공하여야 합니다.
      </p>
      <p className={classes.agreeP}> 1. 재화 등의 검색 및 선택</p>
      <p className={classes.agreeP}>
        {' '}
      ...
      <p className={classes.agreeP}>
        {' '}
        3. 약관내용, 청약철회권이 제한되는 서비스, 배송료․설치비 등의 비용부담과
        관련한 내용에 대한 확인
      </p>
      <p className={classes.agreeP}>
        {' '}
      ...
      <p className={classes.agreeP}> 6. 결제방법의 선택</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제10조 (계약의 성립)</p>
      <p className={classes.agreeP}>
        ① “몰”은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지
        않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의
      ...
      <p className={classes.agreeP}>
        ③ “몰”의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및 판매가능
        여부, 구매신청의 정정 취소 등에 관한 정보 등을 포함하여야 합니다.
      </p>
      <br />
      <p className={classes.agreeP}>
        제11조(지급방법) “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은
        다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의
      ...
      <p className={classes.agreeP}> 3. 온라인무통장입금</p>
      <p className={classes.agreeP}> 4. 전자화폐에 의한 결제</p>
      <p className={classes.agreeP}> 5. 수령 시 대금지급</p>
      <p className={classes.agreeP}>
        {' '}
      ...
      <p className={classes.agreeP}>
        ...
        “몰”은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라
        처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제15조의 청약철회
        등에 관한 규정에 따릅니다.
      </p>
      <br />
      <p className={classes.agreeP}>제13조(재화 등의 공급)</p>
      <p className={classes.agreeP}>
        ① “몰”은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이 없는 이상,
        이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록
        주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, “몰”이 이미 재화
        등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은
        날부터 3영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화 등의
      ...
      <p className={classes.agreeP}>
        ...
        재화 등의 내용을 확인하기 위하여 포장 등을 훼손한 경우에는 청약철회를 할
        수 있습니다)
      </p>
      <p className={classes.agreeP}>
        {' '}
      ...
      <p className={classes.agreeP}>
        ...
        조치를 하지 않았다면 이용자의 청약철회 등이 제한되지 않습니다.
      </p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제16조(청약철회 등의 효과)</p>
      <p className={classes.agreeP}>
        ① “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미
        지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화등의
        환급을 지연한때에는 그 지연기간에 대하여 「전자상거래 등에서의
      ...
      <p className={classes.agreeP}>
        ④ 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 “몰”은 청약철회
        시 그 비용을 누가 부담하는지를 이용자가 알기 쉽도록 명확하게 표시합니다.
      </p>
      <br />
      <p className={classes.agreeP}>제17조(개인정보보호)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제18조(“몰“의 의무)</p>
      <p className={classes.agreeP}>
      ...
      <p className={classes.agreeP}> 1. 신청 또는 변경시 허위 내용의 등록</p>
      <p className={classes.agreeP}> 2. 타인의 정보 도용</p>
      <p className={classes.agreeP}> 3. “몰”에 게시된 정보의 변경</p>
      <p className={classes.agreeP}>
        {' '}
      ...
      <br />
      <p className={classes.agreeP}>제21조(연결“몰”과 피연결“몰” 간의 관계)</p>
      <p className={classes.agreeP}>
        ① 상위 “몰”과 하위 “몰”이 하이퍼링크(예: 하이퍼링크의 대상에는 문자,
        그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결 “몰”(웹
      ...
      <br />
      <p className={classes.agreeP}>제22조(저작권의 귀속 및 이용제한)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제23조(분쟁해결)</p>
      <p className={classes.agreeP}>
      ...
      <br />
      <p className={classes.agreeP}>제24조(재판권 및 준거법)</p>
      <p className={classes.agreeP}>
