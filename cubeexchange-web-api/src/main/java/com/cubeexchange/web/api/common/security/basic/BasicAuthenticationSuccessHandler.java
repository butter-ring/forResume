package com.cubeexchange.web.api.common.security.basic;

import com.cubeexchange.web.api.auth.Auth;
...
//        log.debug("]-----] BasicAuthenticationSuccessHandler::onAuthenticationSuccess authentication [-----[ {}", authentication);
        log.debug("]-----] BasicAuthenticationSuccessHandler::onAuthenticationSuccess authentication BASIC [-----[ {}");
